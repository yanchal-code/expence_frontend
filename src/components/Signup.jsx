...
function Signup() {
  ...
  return (
    ...
    <div className="signup-container" style={{marginTop: "-2px"}}>
      <div className="signup-box" style={{ maxWidth: "600px", padding: "3rem" }}>
        <h2>Sign Up</h2>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="row">
            <div className="col-md-6">
              <div className="input-group mb-4">
                ...
                <input type="text" className="form-control" placeholder="User Name" {...register("name")} />
              </div>
          ...
          <div className="text-center">
            <button type="submit" className="signup-btn btn btn-primary w-100">Sign Up</button>
          </div>
        </form>
